...
public extension GFField {
    ...
    /// Creates generic form inline multiple selection field with loading options status
    /// - Parameters:
    ...
    static func inlineMultipleSelection(title: String,
                                        placeHolder: String = "",
    ...
    /// Creates generic form inline multiple selection field
    /// - Parameters:
    ///   - title: The field title
    ///   - placeHolder: The placeholder to show
    ///   - items: The picklist options to show when tapping on the field
