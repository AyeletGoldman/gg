...
enum PutConsultationV2ConsultationConnectLinksExternalIdResponses {
    case status204(Void)
...
extension Publisher where Output == PutConsultationV2ConsultationConnectLinksExternalIdResponses {
