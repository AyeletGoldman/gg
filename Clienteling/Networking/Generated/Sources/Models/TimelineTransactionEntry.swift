...
struct TimelineTransactionEntry: Codable, Equatable {

    enum TimelineTransactionEntryType: String, Codable, Equatable, CaseIterable {
    ...
    let title: String
    let type: TimelineTransactionEntryType
    ...
    init(advisorName: String? = nil, clientId: String, clientName: String? = nil, datetime: ISO8601DateTime, id: String, itemCount: Int, items: [TransactionItem]? = nil, price: Price, storeName: String, title: String, type: TimelineTransactionEntryType) {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.type = try container.mkDecode(TimelineTransactionEntryType.self, forKey: .type)
    }
}
