...
struct TypedValueMultiText: Codable, Equatable {

    enum TypedValueMultiTextType: String, Codable, Equatable, CaseIterable {
    ...
    let type: TypedValueMultiTextType
    let value: [String]?
    ...
    init(apiName: String, copyable: Bool? = nil, translationKey: String? = nil, type: TypedValueMultiTextType, value: [String]? = nil) {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.type = try container.mkDecode(TypedValueMultiTextType.self, forKey: .type)
