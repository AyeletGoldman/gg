...
struct ClientListMember: Codable, Equatable {

    let advisorId: String?
    let clientId: String
    let clientListMemberId: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case clientListMemberId = "clientListMemberId"
    ...
    init(advisorId: String? = nil, clientId: String, clientListMemberId: String? = nil, clientName: String? = nil, detailsFields: [TypedValue]? = nil, segments: [String], subtitle: TypedValue? = nil) {
        self.advisorId = advisorId
        self.clientId = clientId
        self.clientListMemberId = clientListMemberId
    ...
    init(from decoder: Decoder) throws {
        ...
        self.clientListMemberId = try container.mkDecodeIfPresent(String.self, forKey: .clientListMemberId)
