...
struct InteractionV2: Codable, Equatable {
    ...
    init(advisorName: String, advisorStore: Store, channel: InteractionChannel, datetime: ISO8601DateTime, id: String, metadata: InteractionV2Metadata, storeName: String? = nil) {
