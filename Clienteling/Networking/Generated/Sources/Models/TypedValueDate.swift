...
struct TypedValueDate: Codable, Equatable {

    enum TypedValueDateType: String, Codable, Equatable, CaseIterable {
        case date = "date"
    }
    ...
    init(apiName: String, copyable: Bool? = nil, translationKey: String? = nil, type: TypedValueDateType, value: UTCDate? = nil) {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.type = try container.mkDecode(TypedValueDateType.self, forKey: .type)
