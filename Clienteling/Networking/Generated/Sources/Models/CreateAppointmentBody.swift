...
struct CreateAppointmentBody: Codable, Equatable {
    ...
    init(channel: ChannelKey? = nil, clientId: String? = nil, comments: String? = nil, endTime: ISO8601DateTimeString? = nil, startTime: ISO8601DateTimeString? = nil, territoryId: String, topicId: String? = nil) {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.territoryId = try container.mkDecode(String.self, forKey: .territoryId)
