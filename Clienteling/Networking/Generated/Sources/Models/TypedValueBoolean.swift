...
struct TypedValueBoolean: Codable, Equatable {

    enum TypedValueBooleanType: String, Codable, Equatable, CaseIterable {
    ...
    let type: TypedValueBooleanType
    let value: Bool?
    ...
    init(apiName: String, copyable: Bool? = nil, translationKey: String? = nil, type: TypedValueBooleanType, value: Bool? = nil) {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.type = try container.mkDecode(TypedValueBooleanType.self, forKey: .type)
