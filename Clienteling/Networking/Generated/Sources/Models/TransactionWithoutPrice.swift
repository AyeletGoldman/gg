...
struct TransactionWithoutPrice: Codable, Equatable {
    ...
    init(advisorName: String? = nil, clientId: String, clientName: String? = nil, datetime: ISO8601DateTime, id: String, itemCount: Int, items: [TransactionItem]? = nil, storeName: String, title: String) {
