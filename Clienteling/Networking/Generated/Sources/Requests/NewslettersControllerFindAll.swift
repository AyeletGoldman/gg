...
struct NewslettersControllerFindAll: TargetType {
    ...
    var path: String {
        return "/outreach/v1/newsletters"
    }
    ...
    var baseURL: URL {
        return Server.selectedServerForOperationName("NewslettersControllerFindAll").url
    }
}

extension NewslettersControllerFindAll: AccessTokenAuthorizable {
