...
struct ClientsControllerFindDetailsOne: TargetType {
    ...
    var baseURL: URL {
        return Server.selectedServerForOperationName("ClientsControllerFindDetailsOne").url
    }
}

extension ClientsControllerFindDetailsOne: AccessTokenAuthorizable {
