...
struct InteractionsControllerFindAll: TargetType {
    ...
    var baseURL: URL {
        return Server.selectedServerForOperationName("InteractionsControllerFindAll").url
    }
}

extension InteractionsControllerFindAll: AccessTokenAuthorizable {
